...
usecols = ['id','propertyState','latitude','longitude','countyCode','censusBlockGroupFips','reportedZipCode','ratedFloodZone','occupancyType']
...
policies['match_state'] = state
policies['match_countyCode'] = policies['countyCode'].copy()
